...
dashboard = pn.Column(
    dashboard_title,
    pn.Row(overall_price_distribution, house_price_distribution, apartment_price_distribution, sizing_mode="stretch_width", height=700),  # Row 1
    pn.Row(land_price_distribution, villa_price_distribution, price_distribution_by_property_type, sizing_mode="stretch_width", height=700),  # Row 2
    pn.Row(price_distribution_by_number_of_bedroom_for_house, price_distribution_by_number_of_bedroom_for_apartment, price_distribution_by_number_of_bedroom_for_land, sizing_mode="stretch_width", height=700),  # Row 3
    pn.Row(price_distribution_by_number_of_bedroom_for_villa, sizing_mode="stretch_width", height=700),  # Row 4
    # table,
